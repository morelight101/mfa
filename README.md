...
* [`src/mfa/`](src/mfa/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/mfa/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `mfa` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/mfa/config.cljs) defaults to `true` in
